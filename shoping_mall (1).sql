...
(10, 'Noorjahan', 'behind vnc', 583201, 'hospet', 'cihan@gmail.com', 8217434567),
(11, 'Afreen Taj', 'Arvind Nagar', 583201, 'Hosapete', 'salar@gmail.com', 8217482695);
...
(1, 1, 2, 1, 650, 'Dispatched', '2025-06-12'),
(2, 1, 1, 1, 1200, 'Processing', '2025-06-12'),
(3, 1, 2, 1, 650, 'Processing', '2025-06-13'),
(4, 1, 5, 1, 2000, 'Processing', '2025-06-13');
...
INSERT INTO `customer_payments` (`cust_pay_id`, `cust_order_id`, `total_amount`, `status`, `date`, `tranc_id`) VALUES
(1, 1, 650, 'PAID', '2025-06-12', 'pay_QgEJ6puB5MvQCa'),
(2, 2, 1200, 'PAID', '2025-06-13', 'pay_Qga35pMWKizPaO'),
(3, 1, 650, 'PAID', '2025-06-13', 'pay_QgdeUo1qx2Nryh'),
(4, 4, 2000, 'PAID', '2025-06-13', 'pay_QggarsqFRYohcr'),
(5, 3, 650, 'PAID', '2025-06-13', 'pay_Qggf2bETjvKb2X');
...
(6, 'san@gmail.com', '12345', 'customer', 'Enter Your Contact No', '8970403943', 'Actie'),
(10, 'cihan@gmail.com', 'Cihansikandar123', 'customer', 'Enter Your Contact No', '8217434567', 'Actie'),
(11, 'salar@gmail.com', 'Salarsikander123', 'customer', 'Enter Your Contact No', '8217482695', 'Actie');
...
INSERT INTO `product_catalog` (`product_id`, `product_name`, `product_description`, `product_rate`, `product_image`) VALUES
(1, 'Palazzo set', 'palazzo kurta for women', 1200, 'kurta palazzo.webp'),
(2, 'women kurti', 'plain green kurti', 650, 'green_kurti.webp'),
(3, 'Anarkali set', 'party wear Anarkali set', 1500, 'party wear kurta.jpg'),
(5, 'Jump suit', 'maroon jump suit for women', 2000, 'maroon-jumpsuit.avif'),
(6, ' Watch', 'Titan Watch', 8000, 'titan watch.webp'),
(7, 'Perfume ', 'Dior perfume for men', 900, 'perfume.jpg'),
(8, 'fruit', 'orange fruit rich in vitamin c', 80, 'orange.jpg'),
(9, 'Toys', 'Toy Car for Babies', 7000, 'toy.jpg'),
(10, 'face wash', 'Face wash for men', 160, 'face wash.webp');
...
INSERT INTO `vendor_payments` (`vendor_payment_id`, `vendor_id`, `payment_no`, `amount`, `mode_of_payment`, `bank_name`, `cheque_dd_no`, `given_date`) VALUES
(1, 2, 1257, 5000, 'cheque', 'Federal', '6758', '2025-06-10');
...
--
-- Dumping data for table `vendor_supply_details`
--

INSERT INTO `vendor_supply_details` (`vendor_supply_id`, `vendor_id`, `product_id`, `quantity`, `purchase_rate`, `supply_date`, `status`) VALUES
(1, 1, 1, 100, 200, '2025-06-12', 'Supply'),
(2, 2, 2, 500, 200, '2025-06-12', 'Supply'),
(3, 5, 4, 100, 300, '2025-06-10', 'Supply'),
(4, 3, 3, 100, 1000, '2025-06-09', 'Supply'),
(5, 4, 5, 100, 1500, '2025-06-09', 'Supply');
...
--
ALTER TABLE `customer_order`
  MODIFY `cust_order_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `customer_payments`
--
ALTER TABLE `customer_payments`
  MODIFY `cust_pay_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `vendor_payments`
  MODIFY `vendor_payment_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `vendor_supply_details`
--
ALTER TABLE `vendor_supply_details`
  MODIFY `vendor_supply_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
COMMIT;
